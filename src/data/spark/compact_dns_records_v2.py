...
# Uses RDD.mapPartitions() to get better performance.
#
...
sc = SparkContext(appName="Compacts DNS Records Oct 2017")
sc.setLogLevel("ERROR")
sqlContext = SQLContext(sc)

in_path = '/user/s1962523/openintel-alexa1m/openintel-alexa1m-201710*/*.json.gz'
out_path = '/user/s1962523/alexa1m-compact-201710'
